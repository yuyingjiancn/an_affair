$(function () {
    window.yns.views.viewInit[window.yns.router.studentExamViewResult.name] = function () {
        ...
        var studentsAnswers = _.map(_.sortBy(studentsAnswersServer, function (s) { return s.studentNumber }), function (a) {
           ...
           return { studentNumber: a.studentNumber, studentName: a.studentName, result: result, score: score };
        });
